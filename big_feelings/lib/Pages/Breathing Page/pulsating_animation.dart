...
class PulsatingCirclesPainter extends CustomPainter {
  final Animation<double> _animation; // Animation controller
  final Color _selectedColor; // Colour for circles
  final bool _inhale; // A bool to see which phase the pulsating is.

  PulsatingCirclesPainter(this._animation, this._selectedColor, this._inhale)
